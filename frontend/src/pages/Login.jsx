      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm font-medium leading-relaxed">
            Sign in to access your loan predictions & risk analytics
          </p>
        </div>
        ...
        <div className="glass p-8 border-white/10 shadow-glow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="btn-neon-rgb w-full flex items-center justify-center gap-2 py-3.5 mt-2 disabled:opacity-60"
            >
              {loading ? (
                <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
              ) : (
                <>
                  <span className="font-bold tracking-wide">Sign In to Account</span>
          ...
          <p className="text-center text-sm text-slate-400 mt-6 font-medium">
            ...
            <Link to="/register" className="gradient-text-cyan font-bold hover:underline">
              Create free account
            </Link>
          </p>
        </div>
